...
function spriteFrameByName(frameName)
...
function addSpriteFramesWithFile(plistFilename, image)
    CCSpriteFrameCache:sharedSpriteFrameCache():addSpriteFramesWithFile(plistFilename, getFilename(image))
end
...
function newAnimation(frames, time)
    local count = #frames
...
function newAnimate(animation, isRestoreOriginalFrame)
